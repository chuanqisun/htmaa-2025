    ...
    (() => {
      ...
      const e = "rendered",
        s = (t, e) => {
          ...
          let s, o;
          return (
            "mousedown" === e.type ? ((s = e.clientX), (o = e.clientY)) : ((s = e.touches[0].clientX), (o = e.touches[0].clientY)),
      ...
      const n = { ArrowLeft: -1, ArrowRight: 1 },
        ...
        h = "undefined" != typeof window && (null === window || void 0 === window ? void 0 : window.HTMLElement);
          ...
          class extends h {
              ...
              (super(),
                ...
                (this.onTouchStart = (t) => {
                  (this.dragByHandle && !s(this.handleElement, t)) ||
                    ((this.touchStartPoint = a(t)), this.isFocused && (this.enableTransition(), this.slideToPage(this.touchStartPoint)));
                }),
                (this.onTouchMove = (t) => {
                  ...
                  if (!this.hasTouchMoved) {
                    ...
                    if (("horizontal" === this.slideDirection && i < s) || ("vertical" === this.slideDirection && i > s))
                      return ((this.isTouchComparing = !0), this.focus(), this.slideToPage(e), t.preventDefault(), !1);
            ...
            connectedCallback() {
              (this.hasAttribute("tabindex") || (this.tabIndex = 0),
                ...
                this.addEventListener("touchstart", this.onTouchStart, { passive: !0 }),
                this.addEventListener("touchmove", this.onTouchMove, { passive: !1 }),
            ...
            setExposure(t = 0) {
              var e;
              ((this.exposure = (100, (e = this.exposure + t) < 0 ? 0 : e > 100 ? 100 : e)),
