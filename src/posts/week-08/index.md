...
- In this final version, I jumped ahead a bit and implement the response synthesis. The playback is on the computer and will be streamed to the micro-controller in next week's Output device assignment
...
- I still observed high latency but working demo for the full input pipeline!
